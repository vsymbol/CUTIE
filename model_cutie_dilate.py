...
class CUTIERes(CUTIE):
    ...
    def setup(self):        
        ...
        (self.feed('embedding')
             ...
             .dilate_conv(3, 5, 256, 1, 1, 2, name='encoder1_3')
             .dilate_conv(3, 5, 256, 1, 1, 2, name='encoder1_4')
             .dilate_conv(3, 5, 512, 1, 1, 2, name='encoder1_5')
             .dilate_conv(3, 5, 512, 1, 1, 2, name='encoder1_6')
             .dilate_conv(3, 5, 256, 1, 1, 2, name='encoder1_7')
             .dilate_conv(3, 5, 256, 1, 1, 2, name='encoder1_8')
